...
Model menu items, sales, and locations using interfaces
Filter and search sales data by location, date, and product
Calculate location performance scores based on multiple metrics
Compute financial metrics (revenue, cost, margin) in multiple currencies
Generate operations reports with aggregated data
...
Currency Handling: All financial calculations work correctly in both USD and COP
What Felipe Expects
...
This is a real Brasaland project. What you build here will become part of the production operations system used across 14 locations in Colombia and Florida.